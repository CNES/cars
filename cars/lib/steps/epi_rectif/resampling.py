...
def epipolar_rectify_images(
    ...
    mask1_classes = input_configuration.get(input_parameters.MASK1_CLASSES_TAG,
                                            None)
    mask2 = input_configuration.get(input_parameters.MASK2_TAG, None)
    mask2_classes = input_configuration.get(input_parameters.MASK2_CLASSES_TAG,
                                            None)
...
def resample_image(
    ...
    dataset = datasets.create_im_dataset(resamp,
                                         region,
                                         largest_size,
                                         band_coords,
                                         msk)
