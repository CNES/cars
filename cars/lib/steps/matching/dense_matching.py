...
def compute_disparity(left_dataset,
    ...
    mask1_classes = input_stereo_cfg[input_parameters.INPUT_SECTION_TAG]\
                                    .get(input_parameters.MASK1_CLASSES_TAG,
                                         None)
    mask2_classes = input_stereo_cfg[input_parameters.INPUT_SECTION_TAG]\
                                    .get(input_parameters.MASK2_CLASSES_TAG,
                                         None)
...
def estimate_color_from_disparity(disp_ref_to_sec: xr.Dataset,
    ...
    interp_clr_ds = datasets.create_im_dataset(final_interp_color,
                                      region,
                                      largest_size,
                                      band_coords=True,
                                      msk=None)
