...
from cars.applications.pandora_sparse_matching import (
    pandora_sparse_matching_tools as pandora_tools,
)
from cars.applications.pandora_sparse_matching.pandora_sparse_matching import (
...
class PandoraLowResolution(
    PandoraSparseMatching, short_name="pandora"
    ...
    def __init__(self, conf=None):
        ...
        self.strip_margins = self.used_config["strip_margins"]
    ...
    def check_conf(self, conf):
        ...
        overloaded_conf["strip_margins"] = conf.get("strip_margins", 10)
        ...
        application_schema = {
            ...
            "strip_margins": And(int, lambda x: x > 0),
    ...
    def get_margins_fun(self, disp_min=None, disp_max=None):
        ...
        left_margin = self.strip_margins
