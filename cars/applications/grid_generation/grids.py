...
from cars.core import former_confs_utils, preprocessing, projection, tiling
...
def compute_epipolar_roi(
    ...
    conf = preprocessing.create_former_cars_post_prepare_configuration(
        sensor_image_left,
        sensor_image_right,
        grid_left,
        grid_right,
    ...
    epipolar_roi = terrain_region_to_epipolar(
        roi_bbox,
        conf,
        geometry_loader,
