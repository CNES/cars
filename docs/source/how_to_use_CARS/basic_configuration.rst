...
.. tabs::
                        ...
                        "inputs": {
                            "depth_maps": {
                                "my_name_for_this_depth_map": {
                                    ...
                                    "ambiguity": "path_to_ambiguity.tif",
    ...
    .. tab:: Output
        ...
        +-------------------------+-------------------------------------------------------------+--------------------+----------------------+----------+
        | *resolution* [#scaled]_ | Output DSM grid step (only for dsm product level)           | float              | 0.5 [#scaled]_       | No       |
        +-------------------------+-------------------------------------------------------------+--------------------+----------------------+----------+
...
.. [#scaled] This parameter is scaled depending on the resolution of the input sensor images. The default parameter given here corresponds to the value used when sensor images are at a resolution of 0.5 meters. You can override it in the given configuration.
