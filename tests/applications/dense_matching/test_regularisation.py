...
from cars.applications.dense_matching import regularisation
...
def test_update_disp_0(
    ...
    path_mask_1 = absolute_data_path(os.path.join(*mask1_path_list))
    path_mask_2 = absolute_data_path(os.path.join(*mask2_path_list))

    # get mask values
    mask1_classes_dict = read_mask_classes(path_mask_1)
    mask1_set_to_ref_alt = mask1_classes_dict.get(
        mask_classes.set_to_ref_alt_tag, None
    )
    mask2_classes_dict = read_mask_classes(path_mask_2)
