...
def test_parse_roi_file():
    ...
    roi_poly, roi_epsg = sensors_inputs.parse_roi_file(path_roi_file)
...
def test_geojson_to_shapely():
    ...
    roi_poly, roi_epsg = sensors_inputs.geojson_to_shapely(geojson_dict)
...
def test_resample_polygon():
    ...
    new_roi_poly = sensors_inputs.resample_polygon(
        roi_poly, roi_epsg, resolution=20
    )
