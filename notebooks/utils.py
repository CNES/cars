...
#
"""
this module contains functions used in notebooks.
"""
...
def set_up_demo_inputs():
    ...
    inputs_tar = os.path.join(inputs_dir, "data_notebook.tar.bz2")

    # decompact samples demo data
    cmd = "tar xfj {} -C {}".format(inputs_tar, inputs_dir)
    os.system(cmd)

    return os.path.join(inputs_dir, "data_notebook")
